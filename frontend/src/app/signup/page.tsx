...
export default function SignupPage() {
  ...
  return (
    <div className="relative mx-auto flex min-h-screen w-full max-w-6xl items-center px-6 py-10">
      <Link href="/" className="absolute top-6 left-6 flex items-center gap-1 text-sm text-[color:var(--on-surface-variant)] transition-colors hover:text-[color:var(--primary)]">
